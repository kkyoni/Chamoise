...
<body style="padding:0px; margin:0px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif">
        ...
        <tr>
            <td>
                <div style="margin:0 auto; text-align:left; font-size:15px; color:#181715; margin-top:40px; line-height:22px; max-width:600px; min-width:340px; width:100%;">
                </div>
                            ...
                            <tr>
                                <td class="content-cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 35px;">
                                    ...
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        You have Received new password. 
                                    ...
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Thank You,<br> Admin </p>
                                </td>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-12 text-center footer_text">
                                            Copyright <a href="#"></a> @ {{ date('Y') }}. All Rights Reserved
                                        </div>
                                    </div>
                                </div>
                            </tr>
